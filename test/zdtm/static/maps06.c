...
int main(int argc, char **argv)
{
	...
	tmp = pstt_mmap_in_task(task1, NULL,
	...
	tmp = pstt_mmap_in_task(task6, NULL,
	...
	tmp = pstt_mmap_in_task(task3, NULL,
	...
	tmp = pstt_mmap_in_task(task4, NULL,
	...
	tmp = pstt_mmap_in_task(task7, NULL,
	...
	tmp = pstt_mmap_in_task(task8, NULL,
	...
	tmp = pstt_mmap_in_task(task9, NULL,
	...
	tmp = pstt_mmap_in_task(task11, NULL,
